...
export default function CRDashboard() {
  ...
  const overview = (data as any).class_overview || {}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{overview.classes_attended || 0}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Classes Conducted</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{overview.classes_conducted || 0}</p>
            </div>
          </div>
        </div>
      )}
